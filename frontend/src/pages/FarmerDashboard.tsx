      ...
      <div className="flex flex-col justify-between gap-6 rounded-3xl border border-zinc-200/70 bg-white p-6 sm:p-7 shadow-xs sm:flex-row sm:items-center">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-2xl border border-emerald-600/40 bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-900 shadow-xs transition hover:bg-emerald-100 hover:border-emerald-500 active:scale-95"
