...
import { ArrowRight, Leaf, Truck, Wheat } from "lucide-react";
  ...
  return (
    <div className="bg-[#f7f4ec] text-[#1c2b22]">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#142018]">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mt-10">
            <Link
              to="/shop"
              className="inline-flex items-center gap-2 rounded-full bg-[#e8b84a] px-8 py-3.5 text-sm font-bold text-[#1c2b22] shadow-lg"
            >
              Shop now
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <h2 className="font-serif text-3xl md:text-4xl">How harvest travels</h2>
...
function RoleCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-5 text-sm font-semibold text-[#2f7a4a]">Continue →</p>
    </Link>
  );
}
...
function Story({
  ...
  return (
    <article>
      <img src={image} alt="" className="h-52 w-full rounded-2xl object-cover" />
